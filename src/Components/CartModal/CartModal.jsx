  ...
  return (
    <div>
      <dialog id="my_modal_3" className="modal ">
        <div className="modal-box lg:max-w-[1000px] h-[573px] bg-white dark:bg-slate-900">
          <form method="dialog">
            <button className="btn btn-sm btn-circle btn-ghost absolute right-2 text-2xl top-2 focus:outline-none">✕</button>
          </form>
