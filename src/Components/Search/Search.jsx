...
function Search() {
  ...
  return (
    <div onClick={() => document.getElementById('my_modal_2').showModal()} className="mt-3 xl:w-48 xl:h-12 lg:w-40 h-12 border border-main-Color rounded-lg  relative cursor-pointer disabled:curs">
